 ...
 * drifted across bands (1.21.x renamed them to snake_case, e.g. {@code doMobLoot} to {@code mob_drops}) would set
 * nothing while the run stays green. Taking the name from the {@code GameRules.Key} field instead (e.g. {@code
