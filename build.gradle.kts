...
// (wdl.java-conventions, wdl.nullness-conventions); each subproject applies the ones it needs.
plugins {
    ...
    // Loom 1.17's marker requires Gradle's plugin API 9.5.0+, incompatible with the Gradle 8.x line the root
    // wrapper pins, which is exactly why this band provisions Forge through Unimined instead.
