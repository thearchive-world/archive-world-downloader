 ...
 * {@code net.minecraft.core.Registry} tables (blocks, items, biomes), populated by the idempotent vanilla bootstrap;
 * there is no composite {@code RegistryAccess} (that is the 1.16 rework). So this only runs the bootstrap, and a test
 * that needs a biome reads the static {@code Registry.BIOME} directly.
 *
