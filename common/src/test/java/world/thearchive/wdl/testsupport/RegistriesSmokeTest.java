 ...
 * populate the dynamic {@code BIOME} registry. The assertions exercise the biome lookup the chunk codec relies on and
 * build a {@link LevelChunkSection} the way the codec does.
 */
