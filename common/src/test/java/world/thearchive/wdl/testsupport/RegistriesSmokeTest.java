 ...
 * bootstrap closely enough to populate the dynamic {@code BIOME} registry. The assertions exercise the biome lookup the
 * 1.21.8 chunk codec relies on, {@code lookupOrThrow(BIOME).getOrThrow(PLAINS)}, and build a {@link LevelChunkSection}
 * from that registry the way the codec does.
 */
class RegistriesSmokeTest {
    ...
    void buildsBiomeRegistryAndSection() {
        ...
        // The biome-registry read the 1.21.8 chunk codec makes when it builds a section.
