...
/**
 * A save-folder fixture for the export tests: a {@code saves/world/} folder holding a level.dat and a
...
public final class SaveFolders {
    ...
    /** A {@code saves/world/} folder with a level.dat and {@code region/r.0.0.mca} of the given bytes. */
