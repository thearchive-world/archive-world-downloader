...
/**
 * Proves the Unimined-provisioned MCP jar actually runs under the Java 8 target: the jar loads, its static initializers
 * run, and its classes bind the descriptors the compiled bytecode expects. A {@link NoClassDefFoundError} or
 * {@link NoSuchMethodError} here means the provision is wrong.
 */
class BootSmokeTest {
    @BeforeAll
