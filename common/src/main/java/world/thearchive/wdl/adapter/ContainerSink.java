 ...
 *
 * <p>The live step ({@link #captureItems(NonNullList, RegistryAccess)}) serializes the items lifted from the open
 * menu's container slots. The pure step ({@link #merge(CompoundTag, CompoundTag)}) sets {@code "Items"} on a copy of an
