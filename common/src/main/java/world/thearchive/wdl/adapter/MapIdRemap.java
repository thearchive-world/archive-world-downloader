 ...
 * over the shared {@link ItemTreeWalk}.
 *
...
final class MapIdRemap {
     ...
     * containers. The entry point for an entity-borne single item (an item frame's {@code "Item"}, a dropped item
     * entity's {@code "Item"}); {@code item} is mutated in place and must be remapped exactly once.
     */
