 ...
 * the synced data values as the synced-value payload, and the equipment slot/stack pair as the equipment payload. On
 * this band the spawn payload arrives split across four packets, {@code AddEntity}, {@code AddMob},
