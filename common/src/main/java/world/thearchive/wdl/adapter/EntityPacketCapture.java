 ...
 * into {@code AddEntity} at 1.19 and 1.21.5. {@code SynchedEntityData.DataValue} is the synced-value payload and the
 * equipment slot/stack pair the equipment payload. This band has no {@code Entity.recreateFromPacket} (added at 1.17),
 * so the reconstruct builds each hanging entity through its positioned constructor rather than letting the packet fill
 * the facing.
 *
