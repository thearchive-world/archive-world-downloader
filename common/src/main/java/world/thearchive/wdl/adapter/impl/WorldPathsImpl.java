...
/**
 * 1.21.11 save-layout axis. Rooted at a single world save directory; maps a dimension to its vanilla on-disk folders
 * and pre-creates {@code region/} + {@code entities/} so the region writer never sees a missing {@code externalFileDir}
