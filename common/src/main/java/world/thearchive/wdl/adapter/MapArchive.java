 ...
 * holder drains rather than being lost at finish. It wraps a {@link MapManifest} (the persisted hash-to-id table and
...
final class MapArchive {
     ...
     * shulkers, and stream each first-imaged map's data on the way (the on-sight stream). Single-pass: call exactly
