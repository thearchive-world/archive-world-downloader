 ...
 * {@link ChunkMerge}. The saddle rides in the synced equipment every capture re-reads, so it needs no carry-forward
 * key.
 */
final class EntityMerge {
     ...
     * UUID-keyed sibling of {@link ChunkMerge#hasCapturedContent}. A content key added here must be added to the
     * carry-forward too.
     */
