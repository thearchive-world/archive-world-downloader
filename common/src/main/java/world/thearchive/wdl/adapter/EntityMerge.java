...
/**
 * The read-merge for a chunk's captured entities, UUID-keyed (the {@code SerializableUUID.CODEC} 4-int array). At
 * 1.16.5 the entities live inside the {@code region/} chunk under {@code Level.Entities} (there is no separate
