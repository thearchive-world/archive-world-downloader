...
final class PlayerTag {
     ...
     * reads this back as the integer id ({@code Entity.load}), so it is written as the id, not the 1.16 string form: a
     * string here is read by {@code getInt} as 0 and lands the player in the overworld.
     */
