...
final class PlayerTag {
     ...
     * vehicle serialized standalone. Mirrors vanilla's player save, whose record its player load reads on open (a
     * singleplayer saved player included) to respawn the vehicle and re-seat the player; an absent record is a clean
     * load that leaves the player standing.
     */
