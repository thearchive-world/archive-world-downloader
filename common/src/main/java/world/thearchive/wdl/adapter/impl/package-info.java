 ...
 * {@code gradle.properties}; this branch targets 1.20.4). The package is role-named, not version-named, because a
 ...
 * {@link VersionAdapterImpl#BAND_FLOOR}, validated at 1.20.4).
 */
@NullMarked
