 ...
 * {@code gradle.properties}; this branch targets 1.14.4). The package is role-named, not version-named, because a
 ...
 * {@link VersionAdapterImpl#BAND_FLOOR}, validated at 1.14.4).
 */
@NullMarked
