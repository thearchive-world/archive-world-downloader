 ...
 *
 * <p>Documented limit: the lectern is a 1.14 block, absent at this band, so no lectern block entity is ever captured
 * and this sink never runs against real data. It stays wired behind the band-stable SPI, unused but compiling, so the
 * shared capture path does not fork on the band.
 *
