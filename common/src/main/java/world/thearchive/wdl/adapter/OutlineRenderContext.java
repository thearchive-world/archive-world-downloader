...
public final class OutlineRenderContext {
    ...
    /**
     * @param frustum   the live view frustum for the section cull, or null on a band whose loader render event no
     *                  longer exposes one (26.x fabric-api), where every section is drawn and off-screen geometry is
