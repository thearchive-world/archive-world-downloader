...
dependencies {
    ...
    // JourneyMap provides it jar-in-jar). The -forge flavor carries classic MCP names, matching this build; the Forge
    // island reads the same key and pins the same flavor.
