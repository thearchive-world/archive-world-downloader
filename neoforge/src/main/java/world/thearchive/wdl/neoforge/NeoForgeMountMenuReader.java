 ...
 * the NeoForge access transformer (the mount-inventory menu's mount).
 */
final class NeoForgeMountMenuReader extends MountMenuReader {
    @Override
    protected @Nullable Entity mount(AbstractContainerMenu menu) {
        // access-transformed: net.minecraft.world.inventory.AbstractMountInventoryMenu mount
        return menu instanceof AbstractMountInventoryMenu mountMenu ? mountMenu.mount : null;
    }
}
