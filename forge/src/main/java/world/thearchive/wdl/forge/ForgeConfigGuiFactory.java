 ...
 * constructor. The mods list greys its config button out unless {@link #mainConfigGuiClass} answers non-null, and opens
 * the class it answers by calling a public {@code (GuiScreen)} constructor on it, which is why that answer is
 * {@link ForgeConfigGuiTrampoline} rather than the settings screen itself.
 */
