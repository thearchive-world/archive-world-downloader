...
public final class WdlForge {
    public WdlForge() {
        ...
        // 1.17-and-above bands register by its class. Forge 25.x grays the mods-list config button out for every mod,
        // gating it on ModInfo.hasConfigUI, a hardcoded false that 1.14 replaced with a getGuiFactoryFor presence
        // check; the press path itself already resolves this registration.
