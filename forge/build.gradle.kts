...
// The non-Fabric jar for this deep band, a separate Gradle build beside the root. This band predates the Mojmap
// floor (Mojang published no official mappings before 1.14.4), so the toolchain reaches for classic MCP (searge
// intermediary plus the MCP project's community names) instead, exactly as common/build.gradle.kts does.
